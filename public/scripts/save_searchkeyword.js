$(document).ready(function () {
    ...
    for (var i = 0; i < recentSearches.length; i++) {
        ...
        var itemText = $("<span></span>")
                ...
                .click(function() {
                    ...
                    // var url = "/bookstore_search?value=" + encodeURIComponent(keyword);
                    var url = "/bookstore_search?value=" + encodeURIComponent(keyword) + "&store=" + encodeURIComponent(store);
    ...
    $("form").submit(function (event) {
        ...
        // 검색어로 재검색
        // var url = "/bookstore_search?value=" + encodeURIComponent(newKeyword);
        var url = "/bookstore_search?value=" + encodeURIComponent(newKeyword) + "&store=" + encodeURIComponent(store);
